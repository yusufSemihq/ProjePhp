...
<optgroup label="Ürünler"></optgroup>
    ...
    <?php $query = $db->query("SELECT * FROM urunler", PDO::FETCH_ASSOC);
if ( $query->rowCount() ){
  ...
  <center><input class="btn btn-outline-success" type="submit" name="sat" value="Satış Yap"></center>
...
<center>  <input type="submit" class="btn btn-danger" name="verisil" value="Kar listesini Temizle" ></center>
<?php   

if (isset($_POST['verisil'])) {
  $sil = $db->exec("DELETE FROM satislar");
    print 'Kar Listesi silindi!';
